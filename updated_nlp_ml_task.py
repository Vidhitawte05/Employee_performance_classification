...
X_tfidf = tfidf_vectorizer.fit_transform(df['Input'])  # ✅ This line fits it
...
print("✅ All models and preprocessors saved correctly.")
...
print("Vocabulary size (should be >0):", len(tfidf_vectorizer.vocabulary_))
